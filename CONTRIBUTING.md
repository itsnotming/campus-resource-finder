# Contributing to Campus Resource Finder

Thank you for your interest in contributing to **Campus Resource Finder**.
...
Before beginning work, comment on the Issue and state that you would like to work on it.
...
All contributors are expected to communicate respectfully.
...
Questions may be submitted through a GitHub Issue labeled **`question`**.
